...
document.querySelector('#infoLeft').innerHTML = '<a href="https://github.com/danchikhub/virtual-keyboard/tree/keyboard" target="_blank">Source Code Keyboard</a>';
document.querySelector('#infoCenter').textContent = 'To change keyboard layout use Alt + Shift';
document.querySelector('#infoRight').innerHTML = '<a href="https://github.com/danchikhub" target="_blank"><img src="https://upload.wikimedia.org/wikipedia/commons/9/91/Octicons-mark-github.svg" alt="GitHUB"></a>';
